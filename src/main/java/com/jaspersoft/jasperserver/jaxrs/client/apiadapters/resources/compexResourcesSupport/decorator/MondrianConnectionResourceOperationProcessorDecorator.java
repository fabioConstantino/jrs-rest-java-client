...
public class MondrianConnectionResourceOperationProcessorDecorator {
    ...
    public MondrianConnectionResourceOperationProcessorDecorator parameter(ResourceServiceParameter param, String value) {
        params.add(param.getName(), UrlUtils.encode(value));
        return this;
    }

    public MondrianConnectionResourceOperationProcessorDecorator parameter(ResourceServiceParameter param, Boolean value) {
        params.add(param.getName(), value.toString());
        return this;
    }

    public MondrianConnectionResourceOperationProcessorDecorator parameter(String param, String value) {
    ...
    public OperationResult<ClientMondrianConnection> createOrUpdate() {
