...
public class DashboardOutputResourceAdapter extends AbstractAdapter {
    ...
    public DashboardOutputResourceAdapter(SessionStorage sessionStorage, String executionId) {
    ...
    public DashboardOutputResourceAdapter(SessionStorage sessionStorage, String executionId, String exportId) {
        super(sessionStorage);
    ...
    public DashboardOutputResourceAdapter withOptions(ExportExecutionOptions options) {
        this.executionOptions = options;
        return this;
    }

    public DashboardOutputResourceAdapter outputFormat(ReportOutputFormat outputFormat) {
        this.executionOptions.setOutputFormat(outputFormat.name().toLowerCase());
        return this;
    }

    public DashboardOutputResourceAdapter outputFormat(String outputFormat) {
        this.executionOptions.setOutputFormat(outputFormat);
        return this;
    }

    public DashboardOutputResourceAdapter attachmentsPrefix(String attachmentPrefix) {
        this.executionOptions.setAttachmentsPrefix(attachmentPrefix);
        return this;
    }

    public DashboardOutputResourceAdapter pages(String pages) {
        this.executionOptions.setPages(pages);
        return this;
    }

    public DashboardOutputResourceAdapter pages(Integer... pages) {
        this.executionOptions.setPages(StringUtils.join(asList(pages), ","));
        return this;
    }

    public DashboardOutputResourceAdapter pages(PageRange pages) {
        this.executionOptions.setPages(pages.getRange());
        return this;
    }

    public DashboardOutputResourceAdapter baseUrl(String uri) {
        this.executionOptions.setBaseUrl(uri);
        return this;
    }

    public DashboardOutputResourceAdapter allowInlineScripts(Boolean value) {
        this.executionOptions.setAllowInlineScripts(value);
        return this;
    }

    public DashboardOutputResourceAdapter markupType(String markupType) {
        this.executionOptions.setMarkupType(markupType);
        return this;
    }

    public DashboardOutputResourceAdapter ignorePagination(Boolean value) {
        this.executionOptions.setIgnorePagination(value);
        return this;
    }

    public DashboardOutputResourceAdapter withErrordescriptor(Boolean value) {
    ...
    public DashboardOutputResourceAdapter suppressContentDisposition(Boolean value) {
